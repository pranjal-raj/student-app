...
public class PdfAddActivity extends AppCompatActivity {
    ...
    private void uploadPdfToStorage() {
        ...
        //path to pdf in firebase storage
    ...
    private void loadPdfCategories() {
        Log.d(TAG, "loadPdgCategories: Loading pdf categories");
    ...
    private void pdfPickIntent() {
        ...
        startActivityForResult(Intent.createChooser(intent, "Select"), PDF_PICK_CODE);
    }
    @Override
